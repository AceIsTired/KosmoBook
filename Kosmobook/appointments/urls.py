...
urlpatterns = [
    ...
    path("dashboard/", views.appointments_dashboard, name="dashboard"),


    #path for professional dashboard 
    path("professional/appointments/",views.appointments_dashboard,name="professional_appointments",),

    #path for customer appointments 
    path("my-appointments/",views.appointments_dashboard,name="my_appointments"),
