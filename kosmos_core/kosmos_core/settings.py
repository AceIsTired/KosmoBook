"""
Django settings for kosmos_core project.
...
SECRET_KEY = 'django-insecure-(4*re#k@#qhcz366fvxe9hip#8db(gp)6v5d_tx9qx5z8fdhe0'
...
WSGI_APPLICATION = 'kosmos_core.wsgi.application'
